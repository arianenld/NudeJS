...
<template>
  	<b-modal id="modal1" :hide-footer=true ref="editUserRef">
		<div>
       ...
       <div v-if="$v.userInfo.user_role.$dirty">
        ...
        <p v-if="!$v.userInfo.user_role.min">*Minimum of three (2) characters.</p>
			...
			<div>
				...
				<b-btn  style="width:80px" text-align="center" v-if="userInfo.user_id  ?  true  :  false"  variant="dark"  @click.prevent="clear()">Cancel</b-btn>
			</div>
			</form>
		</b-card>
		</div>
