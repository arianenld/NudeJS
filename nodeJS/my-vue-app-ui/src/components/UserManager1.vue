<template>
				...
				<tr>
					...
					<th>
						...
						<b-nav-form align="center">
							<input style="margin-right:10px; margin-left:520px; float:right" type="text" v-model="search" v-on:keyup="searchUser(search)" placeholder="Search" name="search"/>
						</b-nav-form>
						</form>
					</th>
					<th>
		...
		<b-nav-form align="center">
			...
			<table style="width:70px" table-layout: fixed class="table table-striped table-hover" hover>
				...
				<tr  v-for="user  in  users"  :key="user.id">
					...
					<td  class="text-right">
					<b-btn style="width:80px" text-align="center" variant="primary" v-b-modal.modal2 @click.prevent="getUser(user)">View</b-btn>
  ...
  <b-modal id="modal2" :hide-footer=true>
      ...
      <b-input-group size="sm" prepend="First Name ">
        <b-form-input v-model="displayModel.user_fname"></b-form-input>
      </b-input-group><br>
      <b-input-group size="sm" prepend="Last Name ">
        <b-form-input v-model="displayModel.user_lname"></b-form-input>
      </b-input-group><br>
      <b-input-group size="sm" prepend="User Email ">
        <b-form-input v-model="displayModel.user_email"></b-form-input>
      </b-input-group><br>
      <b-input-group size="sm" prepend="User Role  ">
        <b-form-input v-model="displayModel.user_role"></b-form-input>
      </b-input-group><br>
      <b-input-group size="sm" prepend="User Status">
        <template v-if="displayModel.user_isdel == 1">
          <b-form-input> Inactive </b-form-input>
        </template>

        <!--<b-form-input  v-if="displayModel.user_isdel == 1"> Inactive </b-form-input>
        <b-form-input v-else> Active </b-form-input>-->
...
// if we are editing a user we deleted, remove it from the form
    ...
    alert(this.displayModel.user_isdel)
